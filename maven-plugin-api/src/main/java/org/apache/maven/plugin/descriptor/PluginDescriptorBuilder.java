...
public class PluginDescriptorBuilder {
  ...
  private List<ComponentDependency>
  extractComponentDependencies(PlexusConfiguration c) {
  ...
  extractComponentDependency(PlexusConfiguration d) {
  ...
  buildComponentDescriptor(PlexusConfiguration c,
                           PluginDescriptor pluginDescriptor)
      throws PlexusConfigurationException {
    ...
    mojo.setInstantiationStrategy(
        c.getChild("instantiationStrategy").getValue());
