...
public class StringSearchModelInterpolatorTest
  ...
  public void testNotInterpolateObjectWithFile() throws Exception {
    ...
    Map<Class<?>, ?> cache =
        (Map<Class<?>, ?>)getField(StringSearchModelInterpolator.class,
                                   "CACHED_ENTRIES")
            .get(null);
    ...
    assertThat(((Object[])getInternalState(objCacheItem, "fields")).length,
               is(0));
    assertThat(((Object[])getInternalState(fileCacheItem, "fields")).length,
               is(0));
  }
