...
public class DefaultBeanConfiguratorTest extends TestCase {
  ...
  public void testMinimal() throws BeanConfigurationException {
    ...
    DefaultBeanConfigurationRequest request =
        new DefaultBeanConfigurationRequest();
  ...
  public void testPreAndPostProcessing() throws BeanConfigurationException {
    ...
    BeanConfigurationPathTranslator translator =
        path -> new File("base", path.getPath()).getAbsoluteFile();
  ...
  static class SomeBean { File file; }
}
