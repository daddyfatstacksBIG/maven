...
public class ProjectModelResolverTest extends AbstractMavenProjectTestCase {
   ...
   */
  public ProjectModelResolverTest() { super(); }
  ...
  private ModelResolver newModelResolver() throws Exception {
    ...
    return new ProjectModelResolver(
        repoSession, null, lookup(RepositorySystem.class),
  ...
  private List<RemoteRepository> getRemoteRepositories()
    ...
    final File repoDir =
        new File(getBasedir(), "src/test/remote-repo").getAbsoluteFile();
    final RemoteRepository remoteRepository =
        new RemoteRepository
            .Builder(org.apache.maven.repository.RepositorySystem
                         .DEFAULT_REMOTE_REPO_ID,
                     "default", repoDir.toURI().toASCIIString())
            .build();
