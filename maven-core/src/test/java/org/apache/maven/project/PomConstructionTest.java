...
*/
  ...
  public void testAppendArtifactIdOfChildToInheritedUrls() throws Exception {
    ...
    assertEquals("http://parent.url/site/child",
  ...
  testInterpolationOfLegacyExpressionsThatDontIncludeTheProjectPrefix()
    ...
    assertEquals("http://dist.org/",
                 pom.getValue("properties/projectDistRepoUrl"));
    assertEquals("http://site.org/",
  ...
  private void testCompleteModel(PomTestWrapper pom) throws Exception {
    ...
    assertEquals("http://project.url/issues",
                 pom.getValue("issueManagement/url"));
    ...
    assertEquals("http://project.url/dist",
                 pom.getValue("distributionManagement/repository/url"));
    assertEquals(
        Boolean.TRUE,
    ...
    assertEquals("http://project.url/snaps",
                 pom.getValue("distributionManagement/snapshotRepository/url"));
    assertEquals(
        Boolean.FALSE,
        pom.getValue(
    ...
    assertEquals("http://project.url/site",
                 pom.getValue("distributionManagement/site/url"));

    assertEquals("http://project.url/download",
                 pom.getValue("distributionManagement/downloadUrl"));
    ...
    assertEquals("http://project.url/remote",
