...
public class MavenSession implements Cloneable {
   ...
   * org.apache.maven.Maven} component before being passed into the session.
   * This is also the potentially constrained set of projects by using
  ...
  public List<String> getGoals() { return request.getGoals(); }
   ...
   * discretion, e.g. via the {@code -Dkey=value} parameter on the command line.
   *
   * @return The user properties, never {@code null}.
   */
  public Properties getUserProperties() { return request.getUserProperties(); }
  ...
  public List<MavenProject> getProjects() { return projects; }
  ...
  public MavenProject getCurrentProject() { return currentProject; }

  public ProjectBuildingRequest getProjectBuildingRequest() {
    return request.getProjectBuildingRequest().setRepositorySession(
        getRepositorySession());
  }

  public List<String> getPluginGroups() { return request.getPluginGroups(); }

  public boolean isOffline() { return request.isOffline(); }

  public MavenProject getTopLevelProject() { return topLevelProject; }

  public MavenExecutionResult getResult() { return result; }
  ...
  public Map<String, Object> getPluginContext(PluginDescriptor plugin,
    ...
    Map<String, Map<String, Object>> pluginContextsByKey =
  ...
  public Date getStartTime() { return request.getStartTime(); }
  ...
  public List<MavenProject> getAllProjects() { return allProjects; }
  ...
  public MavenSession(PlexusContainer container, MavenExecutionRequest request,
                      MavenExecutionResult result, MavenProject project) {
  ...
  public MavenSession(PlexusContainer container, Settings settings,
                      ...
                      EventDispatcher eventDispatcher, ReactorManager unused,
                      List<String> goals, String executionRootDir,
                      Properties executionProperties, Date startTime) {
    this(container, settings, localRepository, eventDispatcher, unused, goals,
         executionRootDir, executionProperties, null, startTime);
  }
  ...
  // so we should really leave this here, possibly indefinitely.
  //
  ...
  /**
   * @deprecated Use either {@link #getUserProperties()} or {@link
   *     #getSystemProperties()}.
   */
  @Deprecated
