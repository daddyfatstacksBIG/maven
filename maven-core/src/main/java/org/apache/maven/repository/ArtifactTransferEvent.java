...
public class ArtifactTransferEvent extends EventObject {
  ...
  public ArtifactTransferEvent(String wagon, final int eventType,
  ...
  public ArtifactTransferEvent(String wagon, final Exception exception,
                               final int requestType,
                               ArtifactTransferResource artifact) {
  ...
  public ArtifactTransferResource getResource() { return artifact; }
  ...
  public byte[] getDataBuffer() { return dataBuffer; }

  public void setDataBuffer(byte[] dataBuffer) { this.dataBuffer = dataBuffer; }
