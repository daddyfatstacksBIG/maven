...
public abstract class AbstractRepositoryMetadata implements RepositoryMetadata {
  ...
  public String getRemoteFilename() { return "maven-metadata.xml"; }
  ...
  public void storeInLocalRepository(ArtifactRepository localRepository,
    ...
    try {
      ...
      throw new RepositoryMetadataStoreException(
          "Error updating group repository metadata", e);
    }
  }
  ...
  protected void updateRepositoryMetadata(ArtifactRepository localRepository,
    ...
    if (metadataFile.length() == 0) {
      if (!metadataFile.delete()) {
        ...
        metadataFile.delete(); // if this fails, forget about it, we'll try to
                               // overwrite it anyway so no need
                               // to delete on exit
      }
  ...
  merge(org.apache.maven.repository.legacy.metadata.ArtifactMetadata metadata) {
    ...
    // should pre-merge, then artifact replaces?
    AbstractRepositoryMetadata repoMetadata =
