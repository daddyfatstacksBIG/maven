...
public class DefaultMojoExecutionConfigurator
  ...
  public void configure(MavenProject project, MojoExecution mojoExecution,
    ...
    if (plugin != null) {
      PluginExecution pluginExecution = findPluginExecution(
          mojoExecution.getExecutionId(), plugin.getExecutions());
      ...
      Xpp3Dom mojoConfiguration =
          (pomConfiguration != null) ? new Xpp3Dom(pomConfiguration) : null;

      mojoConfiguration = Xpp3Dom.mergeXpp3Dom(mojoExecution.getConfiguration(),
                                               mojoConfiguration);
  ...
  findPluginExecution(String executionId,
