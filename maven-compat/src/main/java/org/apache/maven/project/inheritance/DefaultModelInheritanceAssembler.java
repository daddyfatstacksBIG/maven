...
public class DefaultModelInheritanceAssembler
  ...
  public void assembleBuildInheritance(Build childBuild, Build parentBuild,
  ...
  private void assembleModelInheritance(Model child, Model parent,
                                        String childPathAdjustment,
                                        boolean appendPaths) {
    ...
    if (child.getVersion() == null) {
      // The parent version may have resolved to something different, so we take
      // what we asked for... instead of - child.setVersion( parent.getVersion()
      // );
  ...
  private static void mergeReportPluginLists(Reporting child, Reporting parent,
                                             boolean handleAsInheritance) {
      ...
      for (ReportPlugin parentPlugin : parentPlugins) {
        ...
        if (!handleAsInheritance || (parentInherited == null) ||
          ...
          if (childPlugin != null) {
            ...
            mergeReportPluginDefinitions(childPlugin, parentPlugin,
                                         handleAsInheritance);
          }
  ...
  private static void mergeReportSetDefinitions(ReportSet child,
    ...
    childConfiguration =
        Xpp3Dom.mergeXpp3Dom(childConfiguration, parentConfiguration);
  ...
  public static void mergeReportPluginDefinitions(ReportPlugin child,
    ...
    boolean parentIsInherited =
        (parentInherited == null) || Boolean.parseBoolean(parentInherited);
  ...
  private void assembleDistributionInheritance(Model child, Model parent,
    ...
    if (parent.getDistributionManagement() != null) {
      DistributionManagement parentDistMgmt =
          parent.getDistributionManagement();
      ...
      if (childDistMgmt.getRepository() == null) {
        if (parentDistMgmt.getRepository() != null) {
          DeploymentRepository repository =
              copyDistributionRepository(parentDistMgmt.getRepository());
      ...
      // NOTE: We SHOULD NOT be inheriting status, since this is an assessment
      // of the POM quality. NOTE: We SHOULD NOT be inheriting relocation, since
      // this relates to a single POM
    }
  }
  ...
  protected String appendPath(String parentPath, String childPath,
                              String pathAdjustment, boolean appendPaths) {
