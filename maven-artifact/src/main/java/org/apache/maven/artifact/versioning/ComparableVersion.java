 ...
 * separators,</li> <li>transition between characters and digits also
 ...
 * are:<ul> <li><code>alpha</code> or <code>a</code></li> <li><code>beta</code>
 * or <code>b</code></li> <li><code>milestone</code> or <code>m</code></li>
 *     <li><code>rc</code> or <code>cr</code></li>
 *     <li><code>snapshot</code></li>
 *     <li><code>(the empty string)</code> or <code>ga</code> or
 * <code>final</code></li> <li><code>sp</code></li>
 *     </ul>
...
public class ComparableVersion implements Comparable<ComparableVersion> {
  ...
  private static class IntItem implements Item {
    ...
    private IntItem() { this.value = 0; }

    IntItem(String str) { this.value = Integer.parseInt(str); }
  ...
  private static class LongItem implements Item {
    ...
    LongItem(String str) { this.value = Long.parseLong(str); }
  ...
  private static class BigIntegerItem implements Item {
    ...
    BigIntegerItem(String str) { this.value = new BigInteger(str); }
  ...
  private static class StringItem implements Item {
     ...
     *
     * just returning an Integer with the index here is faster, but requires a
     * lot of if/then/else to check for -1 or QUALIFIERS.size and then resort to
     * lexical ordering. Most comparisons are decided by the first character, so
     * this is still fast. If more characters are needed then it requires a
     * lexical sort anyway.
     *
     * @param qualifier
   ...
   * "1.2.7" "1.2-SNAPSHOT"</pre> command to command line. Result of given
   * command will be something like this: <pre> Display parameters as parsed by
   * Maven (in canonical form) and comparison result:
   * 1. 1.2.7 == 1.2.7
   *    1.2.7 &gt; 1.2-SNAPSHOT
