...
public class MultipleArtifactsNotFoundException
  ...
  public MultipleArtifactsNotFoundException(
      Artifact originatingArtifact, List<Artifact> missingArtifacts,
   ...
   */
  public MultipleArtifactsNotFoundException(
      Artifact originatingArtifact, List<Artifact> resolvedArtifacts,
   ...
   */
  public List<Artifact> getResolvedArtifacts() { return resolvedArtifacts; }
   ...
   * @return {@link List} of {@link Artifact}
   */
  public List<Artifact> getMissingArtifacts() { return missingArtifacts; }
  ...
  private static String constructMessage(List<Artifact> artifacts) {
    ...
    for (Artifact artifact : artifacts) {
      ...
      buffer.append(constructMissingArtifactMessage(
          message, "  ", artifact.getGroupId(), artifact.getArtifactId(),
