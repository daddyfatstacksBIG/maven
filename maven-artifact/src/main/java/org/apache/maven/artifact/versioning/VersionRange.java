...
public class VersionRange {
  ...
  public ArtifactVersion getRecommendedVersion() { return recommendedVersion; }

  public List<Restriction> getRestrictions() { return restrictions; }

  /**
   * @deprecated VersionRange is immutable, cloning is not useful and even more
   *     an issue against the cache
   * @return a clone
   */
  @Deprecated
   ...
   * included)</li> <li><code>[1.0,2.0]</code> Versions 1.0 to 2.0 (both
   * included)</li> <li><code>[1.5,)</code> Versions 1.5 and higher</li>
  ...
  public static VersionRange createFromVersionSpec(String spec)
    ...
    while (process.startsWith("[") || process.startsWith("(")) {
      ...
      if (index < 0) {
        throw new InvalidVersionSpecificationException("Unbounded range: " +
                                                       spec);
      }

      Restriction restriction =
          parseRestriction(process.substring(0, index + 1));
      if (lowerBound == null) {
      ...
      if (upperBound != null) {
        if (restriction.getLowerBound() == null ||
          ...
          throw new InvalidVersionSpecificationException("Ranges overlap: " +
                                                         spec);
        }
      }
  ...
  private static Restriction parseRestriction(String spec)
    ...
    if (index < 0) {
      ...
      restriction = new Restriction(version, lowerBoundInclusive, version,
                                    upperBoundInclusive);
    } else {
  ...
  public static VersionRange createFromVersion(String version) {
    ...
    if (cached == null) {
      ...
      cached =
          new VersionRange(new DefaultArtifactVersion(version), restrictions);
   ...
   * of this version range and the specified version range. <p> Note: Precedence
   * is given to the recommended version from this version range over the
   * recommended version from the specified version range.
   * </p>
   *
   * @param restriction the <code>VersionRange</code> that will be used to
   *     restrict this version
   *                    range.
   ...
   * intersection of the restrictions of this version range and the specified
   * version range if both version ranges have restrictions. Otherwise, the
   ...
   * within the intersected restrictions. If the restrictions are empty, this
   * version range's recommended version is used if it is not <code>null</code>.
   * If it is <code>null</code>, the specified version range's recommended
   *         version is used (provided it is non-<code>null</code>). If no
   * recommended version can be obtained, the returned version range's
  ...
  public VersionRange restrict(VersionRange restriction) {
    ...
    // Either the original or the specified version ranges have no restrictions
      ...
      // Use the recommended version from the specified VersionRange since there
      // is no original recommended version
      version = restriction.recommendedVersion;
    }
    /* TODO should throw this immediately, but need artifact
            else
            {
                throw new OverConstrainedVersionException( "Restricting
      ...
      if (res1.getLowerBound() == null || res2.getUpperBound() == null ||
        ...
        if (res1.getUpperBound() == null || res2.getLowerBound() == null ||
          ...
          if (res1.getLowerBound() == null) {
            ...
            int comparison =
                res1.getLowerBound().compareTo(res2.getLowerBound());
            if (comparison < 0) {
              lower = res2.getLowerBound();
              lowerInclusive = res2.isLowerBoundInclusive();
              ...
              lower = res1.getLowerBound();
              lowerInclusive =
                  res1.isLowerBoundInclusive() && res2.isLowerBoundInclusive();
            } else {
              lower = res1.getLowerBound();
              lowerInclusive = res1.isLowerBoundInclusive();
            }
          ...
          if (res1.getUpperBound() == null) {
            ...
            int comparison =
                res1.getUpperBound().compareTo(res2.getUpperBound());
            if (comparison < 0) {
              upper = res1.getUpperBound();
              upperInclusive = res1.isUpperBoundInclusive();
            } else if (comparison == 0) {
              upper = res1.getUpperBound();
              upperInclusive =
                  res1.isUpperBoundInclusive() && res2.isUpperBoundInclusive();
            } else {
              upper = res2.getUpperBound();
              upperInclusive = res2.isUpperBoundInclusive();
            }
          ...
          if (lower == null || upper == null || lower.compareTo(upper) != 0) {
            restrictions.add(
                new Restriction(lower, lowerInclusive, upper, upperInclusive));
  ...
  public ArtifactVersion matchVersion(List<ArtifactVersion> versions) {
    // TODO could be more efficient by sorting the list and then moving along
  ...
  public int hashCode() {
    int hash = 7;
    hash = 31 * hash +
           (recommendedVersion == null ? 0 : recommendedVersion.hashCode());
