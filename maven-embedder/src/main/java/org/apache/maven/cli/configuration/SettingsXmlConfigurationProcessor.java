...
public class SettingsXmlConfigurationProcessor
  ...
  private final Logger logger =
      LoggerFactory.getLogger(SettingsXmlConfigurationProcessor.class);
  ...
  public void process(CliRequest cliRequest) throws Exception {
    ...
    if (commandLine.hasOption(CLIManager.ALTERNATE_GLOBAL_SETTINGS)) {
      globalSettingsFile = new File(
          commandLine.getOptionValue(CLIManager.ALTERNATE_GLOBAL_SETTINGS));
