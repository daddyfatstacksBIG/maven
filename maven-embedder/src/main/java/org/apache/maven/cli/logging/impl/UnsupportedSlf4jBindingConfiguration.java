...
public class UnsupportedSlf4jBindingConfiguration
  ...
  public UnsupportedSlf4jBindingConfiguration(String slf4jBinding,
                                              Map<URL, Set<Object>> supported) {
  ...
  public void activate() {
    logger.warn("The SLF4J binding actually used is not supported by Maven: {}",
                slf4jBinding);
